<x-admin>
                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Master\BuildingType::count() }}</h4>
                                        <p class="mb-0">Total Jenis Bangunan</p>
                                    </div>
    ...
    <x-partials.admin.form-modal :formRoute=" route('dashboard.building-type.store')" id="addTipe"
        icon="ri ri-function-add-line" title="Tambah Data Jenis Bangunan" subtitle="Wajib Diisi">
        @include('admin.master.building-types._fields')
    </x-partials.admin.form-modal>
    <div class="card mt-5">
        <x-partials.admin.export_modal :exportExcel="route('dashboard.community-unit.export')"
            :exportPdf="route('dashboard.building-type.exportPdf')" />
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($buildingTypes as $data)
                        ...
                        <x-partials.admin.form-modal id="editTipe{{ $data->id }}"
                            :formRoute="route('dashboard.building-type.update', $data->id)" method="PUT"
                            title="Edit Jenis Bangunan {{ $data->no }}">

                            @include('admin.master.building-types._fields', ['data' => $data])
    ...
    <x-partials.admin.import_modal :downloadRoute="route('dashboard.template.download', 'building-type')"
        :importRoute="route('dashboard.building-type.import')" />
</x-admin>