    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <form action="{{ route('service.news.update',$news->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="image_subtitle" class="form-control"
                                        placeholder="Keterangan gambar…" value="{{ $news->image_subtitle }}">
                                </div>
                            </div>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // sebelum submit, ambil isi editor
