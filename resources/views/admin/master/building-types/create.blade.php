<x-admin>
     <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4"
        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h3 class="fw-bolder mb-8">Tambah Data Tipe Bangunan</h3>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('dashboard.building-type.store') }}" method="post">
                @csrf
                <div class="mb-4">
                <label for="exampleInputname" class="form-label">Jenis Bangunan</label>
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror " id="exampleInputname" placeholder="Contoh : Rumah">
                   @error('name')
