                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-4">
                        <div class="text-center">
                            ...
                            <h1 class="fw-semibold mb-7 fs-9"><span class="text-danger">429</span> | Terlalu banyak request</h1>
                            <h5 class="fw-semibold mb-7">Terlalu banyak request dihalaman ini.</h5>
