<x-admin>
                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Master\NeighborhoodUnit::count() }}</h4>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Master\NeighborhoodUnit::where('status', 'Aktif')->count() }}
                                        </h4>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Master\NeighborhoodUnit::where('status', 'Nonaktif')->count() }}
                                        </h4>
    ...
    <x-partials.admin.form-modal :formRoute=" route('dashboard.neighborhood-unit.store')" id="addRt"
        icon="ri ri-function-add-line" title="Tambah Data Rt" subtitle="Wajib Diisi">
        @include('admin.master.neighborhood-unit._fields')
    </x-partials.admin.form-modal>
    <div class="card mt-5">
        <x-partials.admin.export_modal :exportExcel="route('dashboard.community-unit.export')"
            :exportPdf="route('dashboard.neighborhood-unit.exportPdf')" />
            ...
            <div class="d-sm-flex justify-content-between align-items-start">
                ...
                <div class="action">
                    ...
                    <a class="btn btn-sm text-white" style="background-color:#2fc692; height:40px;"
                        data-bs-toggle="modal" data-bs-target="#addRt">
                        +
                    </a>
                </div>
            </div>
            ...
            <table class="table dataTable">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($nu as $data)
                        ...
                        <x-partials.admin.form-modal id="editRt{{ $data->id }}"
                            :formRoute="route('dashboard.neighborhood-unit.update', $data->id)" method="PUT"
                            title="Edit Data Rt {{ $data->no }}">

                            @include('admin.master.neighborhood-unit._fields', ['data' => $data])
        ...
        <x-partials.admin.import_modal :downloadRoute="route('dashboard.template.download', 'rw')"
            :importRoute="route('dashboard.neighborhood-unit.import')" />
    </div>
</x-admin>