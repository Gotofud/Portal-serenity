<x-admin>
                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Master\Faq::count() }}</h4>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Master\Faq::where('status', 'Aktif')->count() }}
                                        </h4>
                                        <p class="mb-0">Pertanyaan Aktif</p>
                                    </div>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Master\Faq::where('status', 'Nonaktif')->count() }}
                                        </h4>
                                        <p class="mb-0">Pertanyaan Nonaktif</p>
                                    </div>
                                    <div class="avatar me-sm-6">
    ...
    <div class="card mt-5">
        <x-partials.admin.export_modal :exportExcel="route('dashboard.community-unit.export')" :exportPdf="route('dashboard.faq.exportPdf')"/>
            ...
            <div class="d-sm-flex justify-content-between align-items-start">
                ...
                <div class="action">
                    ...
                    <a class="btn btn-sm text-white" style="background-color:#2fc692; height:40px;"
                        data-bs-toggle="modal" data-bs-target="#addFaq">
                        +
                    </a>
                </div>
            </div>
            ...
            <table class="table dataTable">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($faq as $data)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-warning text-warning d-inline-flex align-items-center justify-content-center p-0"
                                    ...
                                    data-bs-target="#editFaq{{ $data->id }}">
                        ...
                        <x-partials.admin.form-modal id="editFaq{{ $data->id }}"
                            :formRoute="route('dashboard.faq.update', $data->id)" method="PUT"
                            title="Edit Data Faq {{ $data->no }}">
                            @include('admin.master.faq._fields', ['data' => $data])
                        </x-partials.admin.form-modal>
                    @endforeach
                </tbody>
            </table>
    ...
    <x-partials.admin.import_modal :downloadRoute="route('dashboard.template.download', 'faq')"
