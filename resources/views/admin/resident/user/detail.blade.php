            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-body pt-8 pb-8">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            <span class="text-muted d-block mb-1" style="font-size:12.5px;">Verifikasi Email</span>
                            <span class="badge {{ $user->is_verified ? 'bg-label-success' : 'bg-label-warning' }}"
                        ...
                        @if ($user->google_id)
                            <div class="col-12">
                                <div
                                    ...
                                    <img src="{{ asset('assets/img/icons/google-icon.svg') }}" class="img-fluid me-2"
                                        width="18" height="18">
                ...
                <div class="card-body">
                    @if ($user->user_profile)
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <span class="text-muted d-block mb-1" style="font-size:12.5px;">Status Keluarga</span>
                                <div class="fw-bold text-dark" style="font-size: 13.5px;">
                                    {{ $user->user_profile->family_status ?? '-' }}
                                </div>
                            </div>
                            <div class="col-12">
                                <span class="text-muted d-block mb-1" style="font-size:12.5px;">Kewarganegaraan</span>
                                <div class="fw-bold text-dark" style="font-size: 13.5px;">
                    ...
                    @else
                        <div class="text-muted fs-7 py-5 text-center">
                            <div style="font-size:32px; margin:0 auto 12px; opacity:0.5;"><i class="ri ri-profile-line"></i></div>
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body pt-2 pb-8">
                    @if ($user->user_house && $user->user_house->is_primary == 'Rumah Utama')
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fw-bold text-dark" style="font-size: 13.5px;">{{ $user->user_house->status }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <span lass="text-muted d-block mb-1" style="font-size:12.5px;">Jumlah Penghuni</span>
                                <div class="fw-bold text-dark" style="font-size: 13.5px;">
                            ...
                            <div class="col-md-4">
                                <span lass="text-muted d-block mb-1" style="font-size:12.5px;">Terdaftar Sejak</span>
                                <div class="fw-bold text-dark" style="font-size: 13.5px;">
                    ...
                    @else
                        <div class="text-muted fs-7 py-5 text-center">
                            <div style="font-size:32px; margin:0 auto 12px; opacity:0.5;"><i class="ri ri-home-2-line"></i></div>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-muted fs-7 py-5 text-center">
                            <div style="font-size:32px; margin:0 auto 12px; opacity:0.5;"><i class="ri ri-e-bike-2-line"></i></div>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body pt-2 pb-8">
                    ...
                    @if ($otherHouses && $otherHouses->count() > 0)
                        <div class="row mb-3 border-bottom pb-2">
                            <div class="col-1"><span class="text-muted" style="font-size:12.5px;">#</span></div>
                            <div class="col-3"><span class="text-muted" style="font-size:12.5px;">Blok / Nomor</span></div>
                            <div class="col-2"><span class="text-muted" style="font-size:12.5px;">Jenis Bangunan</span></div>
                            <div class="col-2"><span class="text-muted" style="font-size:12.5px;">Status</span></div>
                            <div class="col-2"><span class="text-muted" style="font-size:12.5px;">Penghuni</span></div>
                            <div class="col-2"><span class="text-muted" style="font-size:12.5px;">Terdaftar Sejak</span></div>
                        </div>
                        ...
                        @foreach ($otherHouses as $house)
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-2">
                                    <span class="badge {{ $house->status === 'Aktif' ? 'bg-label-success' : ($house->status === 'Disewakan' ? 'bg-label-info' : 'bg-label-warning') }}" style="font-size: 12.5px;">
                                        {{ $house->status }}
                                    </span>
                                </div>
                    ...
                    @else
                        <div class="text-muted fs-7 py-5 text-center">
                            <div style="font-size:32px; margin:0 auto 12px; opacity:0.5;"><i class="ri ri-building-line"></i></div>
