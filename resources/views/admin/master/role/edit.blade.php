     ...
     <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4"
        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h3 class="fw-bolder mb-8">Edit Data Role</h3>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('dashboard.role.update',$role->id) }}" method="post">
                ...
                <input type="text" name="name" value="{{ $role->name }}" class="form-control @error('name') is-invalid @enderror " id="exampleInputname" placeholder="Masukan Nama Role">
                   @error('name')
