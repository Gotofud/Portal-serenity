<x-admin>
                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Master\Block::count() }}</h4>
                                        <p class="mb-0">Total Blok </p>
                                    </div>
    ...
    <x-partials.admin.form-modal :formRoute=" route('dashboard.block.store')" id="addBlock"
        icon="ri ri-function-add-line" title="Tambah Data Blok" subtitle="Wajib Diisi">
        @include('admin.master.block._fields')
    </x-partials.admin.form-modal>
    <div class="card mt-5">
        <x-partials.admin.export_modal :exportExcel="route('dashboard.community-unit.export')"
            :exportPdf="route('dashboard.block.exportPdf')" />
            ...
            <table class="table dataTable">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($block as $data)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-warning text-warning d-inline-flex align-items-center justify-content-center p-0"
                                    ...
                                    data-bs-target="#editBlock{{ $data->id }}">
                        ...
                        <x-partials.admin.form-modal id="editBlock{{ $data->id }}"
                            :formRoute="route('dashboard.block.update', $data->id)" method="PUT"
                            title="Edit Blok {{ $data->no }}">
                            @include('admin.master.block._fields', ['data' => $data])
                        </x-partials.admin.form-modal>
                    @endforeach
                </tbody>
            </table>
    ...
    <x-partials.admin.import_modal :downloadRoute="route('dashboard.template.download', 'block')"
