                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-4">
                        <div class="text-center">
                            ...
                            <h1 class="fw-semibold mb-7 fs-9"><span class="text-danger">405</span> | Method Dilarang</h1>
                            <h5 class="fw-semibold mb-7">Method yang anda gunakan tidak diperbolehkan.</h5>
