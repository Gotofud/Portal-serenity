<x-admin>
                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Finance\CommunityUnitAggrements::count() }}</h4>
                                        <p class="mb-0">Total Kesepakatan </p>
                                    </div>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Finance\CommunityUnitAggrements::where('status', 'Aktif')->count() }}
                                        </h4>
                                        <p class="mb-0">Kesepakatan Aktif</p>
                                    </div>
                            ...
                            <div class="col-sm-8 col-lg-4">
                                <div
                                    ...
                                    <div>
                                        <h4 class="mb-0">
                                            {{ App\Models\Finance\CommunityUnitAggrements::where('status', 'Nonaktif')->count() }}
                                        </h4>
                                        <p class="mb-0">Kesepakatan Nonaktif</p>
                                    </div>
                                    <div class="avatar me-sm-6">
    ...
    <x-partials.admin.form-modal :formRoute=" route('finance.agreement.store')" id="addAgg" icon="ri ri-function-add-line"
        title="Tambah Data Kesepakatan" subtitle="Wajib Diisi">
            ...
            <div class="d-sm-flex justify-content-between align-items-start">
                ...
                <div class="action">
                    ...
                    <a class="btn btn-sm text-white" style="background-color:#2fc692; height:40px;"
                        data-bs-toggle="modal" data-bs-target="#addAgg">
                        +
                    </a>
                </div>
            </div>
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($agreement as $data)
                        <tr>
                            ...
                            <td class="text-center">{{ Number::currency($data->bill_amount, 'IDR', 'id') }}</td>
                            <td><span
                            ...
                            <td>
                                <a class="btn btn-outline-warning text-warning d-inline-flex align-items-center justify-content-center p-0"
                                    ...
                                    data-bs-target="#editAgg{{ $data->id }}">
                        ...
                        <x-partials.admin.form-modal id="editAgg{{ $data->id }}"
                            :formRoute="route('finance.agreement.update', $data->id)" method="PUT"
                            title="Edit Data Faq {{ $data->no }}" >
                            @include('admin.finance.agreement._fields', ['data' => $data])
                        </x-partials.admin.form-modal>
                    @endforeach
                </tbody>
            </table>
